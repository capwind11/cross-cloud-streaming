...
import org.example.flink.workload.network.beans.UserBehavior;
...
public class UvWithBloomFilter {
    public static void main(String[] args) throws Exception {
        ...
        // 2. 读取数据，创建DataStream
        DataStream<String> inputStream = env.readTextFile("/Users/zhangyang/experiment/benchmark/flink_second_understand/FlinkStudy/src/main/java/com/threeknowbigdata/flink/networkflow_analysis/data/UserBehavior.csv");
